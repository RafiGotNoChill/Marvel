...
/_/  /_/\__,_/_/    |___/\___/_/   
         ...
         Made by: FLΣX™〢Dєɱɵŋ ♡#3334
        Github: https://github.com/RafiGotNoChill
''')
...
class Marvel:
    ...
    async def ThemeChanger(self):
        os.system(f'cls & mode 80, 20 & title  [Marvel Nuker] Theme Changer (Credits: Avery Nuker)')
        members_count = 0
...
Github: https://github.com/RafiGotNoChill                                                           
    ...
    async def Menu(self):
        os.system(f'cls & mode 80, 20 & title  [Marvel Nuker] Connected with {client.user}')
        members_count = 0
        for g in client.guilds:
            member_count = len(g.members)
        banner2 = Center.XCenter(f'''
